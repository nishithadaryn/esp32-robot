...
// #include "ps4.h"  // Uncomment if you have a library for PS4 control
// #include "ps4_int.h"  // Uncomment if you have a library for PS4 control
...
void sppInit() {
  ...
  // Bluetooth initialization (for Bluetooth usage)
...
#ifndef ARDUINO_ARCH_ESP32
  // Bluetooth deinitialization (for Bluetooth usage)
